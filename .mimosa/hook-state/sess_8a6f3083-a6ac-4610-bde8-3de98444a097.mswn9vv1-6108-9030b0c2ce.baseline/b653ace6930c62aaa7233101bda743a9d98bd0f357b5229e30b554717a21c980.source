...
export default function FileSelectionDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="!max-w-[1000px] !w-[95vw] max-h-[85vh] flex flex-col p-0 !fixed">
                ...
                <div className="p-5 flex-1 flex flex-col min-h-0 space-y-3 overflow-y-auto">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {fileTypes.length > 0 && (
                            <div className="flex items-center gap-1">
                                ...
                                <select
                                    ...
                                    className="h-9 px-2 py-1 border border-border rounded text-xs text-foreground"
                                >
                        ...
                        <div className="flex border border-border rounded overflow-hidden">
                            <button
                                ...
                                className={`px-3 py-1.5 text-xs font-medium ${viewMode === "tree" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground hover:bg-muted"}`}
                            >
                                树形
                            </button>
                            <button
                                onClick={() => setViewMode("flat")}
                                className={`px-3 py-1.5 text-xs font-medium border-l border-border ${viewMode === "flat" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground hover:bg-muted"}`}
                            >
                                列表
                            </button>
                        </div>
                    ...
                    {/* 文件列表 */}
                    <div className="border border-border bg-muted/20 relative h-[450px] overflow-hidden rounded-lg">
                        {loading ? (
