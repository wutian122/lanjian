...
class LLMService:
    ...
    def get_agent_timeout_config(self) -> Dict[str, int]:
        ...
        return {
            'llm_first_token_timeout': user_llm_config.get('llmFirstTokenTimeout') or getattr(settings, 'LLM_FIRST_TOKEN_TIMEOUT', 120),
    ...
    def config(self) -> LLMConfig:
        ...
        if self._config is None:
            ...
            self._config = LLMConfig(
                ...
                frequency_penalty=float(getattr(settings, 'LLM_FREQUENCY_PENALTY', 0.0)),
            )
        return self._config
