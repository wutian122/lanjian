...
```
=== 服务器 B (192.168.238.11 amd64) ===
SUPERADMIN_PASSWORD = ^2rybCmErJVZl5I7Lym$
POSTGRES_PASSWORD   = 1lHQKZh9owabGJyIzMgKKer4IkYqK24L

=== 服务器 A (10.129.7.87 arm64，SSH 端口 62222) ===
SUPERADMIN_PASSWORD = l4q*538k#AWvF*9U9jEq
POSTGRES_PASSWORD   = UY4pBpLKNtdeNbR3gOxXRfoXyQVSocrS

=== 两台共用 ===
SECRET_KEY = cO3S6R2ALJNQHKXaTW09MtvsnimlEIy8uFbqBhop41CdrkZwjYUfV7xz5egDPG
```
