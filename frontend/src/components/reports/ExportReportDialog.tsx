...
import { FileJson, FileText, Download, Loader2, FileSearch } from "lucide-react";
                    ...
                    <div className="mt-6 border border-border rounded-lg bg-muted/50">
                        ...
                        <div className="p-4 grid grid-cols-2 gap-3 text-xs">
                            <div className="flex items-center justify-between border-b border-border pb-2">
                                ...
                                <span className="font-semibold text-foreground">{task.project?.name || "未知"}</span>
                            </div>
                            <div className="flex items-center justify-between border-b border-border pb-2">
                            ...
                            <div className="flex items-center justify-between border-b border-border pb-2">
                                ...
                                <span className="font-semibold text-foreground">{task.scanned_files}/{task.total_files}</span>
                            </div>
                            <div className="flex items-center justify-between border-b border-border pb-2">
                            ...
                            <div className="flex items-center justify-between border-b border-border pb-2">
                                ...
                                <span className="font-semibold text-foreground">{task.total_lines.toLocaleString()}</span>
                            </div>
                            <div className="flex items-center justify-between border-b border-border pb-2">
