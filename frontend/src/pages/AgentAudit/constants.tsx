...
export const POLLING_ADAPTIVE = {
  PHASE_1_DURATION: 2 * 60 * 1000,
  PHASE_2_DURATION: 5 * 60 * 1000,
  PHASE_3_DURATION: 15 * 60 * 1000,
  PHASE_1_INTERVAL: 2000,
  PHASE_2_INTERVAL: 5000,
  PHASE_3_INTERVAL: 15000,
  PHASE_4_INTERVAL: 60000,
};
